...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'todo-volt.com'
  config.app_name = 'Todo_volt'
  config.mailer.from = 'Todo_volt <no-reply@todo-volt.com>'
  ...
  #
  config.app_secret = 'X4Jgn4uPj60WnkZ4sIcUvdyV8ILK4AKIr5WbMBi1j9vbF1Cr2UkZ2JXqpM6NHS4ha4s'
